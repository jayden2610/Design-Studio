# Legacy/reference workflow (HTML → Canva design)

> **Not the current Etsy-carousel production path.** For active Female Lifestyle Carousel packs, use the verified native editable PPTX and Canva's normal local upload flow. See the root `README.md` and `03 Canva Exports/Canva Delivery Package/MANUAL-CANVA-RUNBOOK.md`.
>
> Keep this document only as a reference for a future public-URL HTML import experiment or a sticker-library-specific need. It requires public hosting and is not a substitute for the private PPTX → Canva workflow.
